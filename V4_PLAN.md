# SignFlow V4 기획서 — Samsung VXT CMS 벤치마킹 기반
...
### 1.2 SignFlow V3 vs VXT CMS 기능 비교

| 기능 영역 | SignFlow V3 | VXT CMS | 비고 |
|----------|------------|---------|------|
| 콘텐츠 업로드 | ✅ | ✅ | 동일 수준 |
| 플레이리스트 | ✅ | ✅ | 동일 수준 |
...
## 부록 C: VXT CMS 역할 구조 vs SignFlow 역할 구조 비교

| VXT CMS | 역할 수준 | SignFlow V4 |
|---------|---------|------------|
...
- SignFlow는 플랫폼 > 업체(Tenant) > 매장(Store) > 사용자
- V4에서는 SignFlow의 계층 구조가 더 SaaS에 적합 (현행 유지)
